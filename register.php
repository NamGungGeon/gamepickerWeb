...
<body>
    <section class="contents">
        <div class="wrap">
            ...
            <div class="terms">
                <span class="justSquare"></span>
                <span class="title">&nbsp;회원가입에 관한 약관</span>
                <br/><br/>
                <p>
                    제1조(목적)

                    이 약관은 ㈜게임피커(이하 “회사”라 합니다)가 제공하는 게임 서비스(이하 “서비스”라 합니다) 이용과 관련하여 회사와 이용자간의 권리∙의무 및 기타 필요한 제반사항을 정함을 목적으로 합니다.
                    ...
                    “단말기”란 서비스를 이용할 수 있는 휴대폰, 스마트폰, 태블릿 등 유∙무선 기기를 말합니다.
                    ...
                    “In-App결제”란 애플리케이션 내에서 유료콘텐츠를 구매하기 위한 결제 행위를 말합니다.
                    ...
                    ① 회사는 이용자 계정(임시 계정 포함. 이하 같습니다)을 통하여 이용자의 서비스 이용 가능 여부 등 제반 이용자 관리업무를 수행합니다.
                    ...
                    ① 이용자는 회사에서 제공하는 서비스를 서비스 본래의 이용 목적 이외의 용도로 사용하거나 다음 각호의 어느 하나에 해당하는 행위를 하여서는 안됩니다.

                    이용자 문의, 유료콘텐츠 복구 및 환불 요청, 이벤트 당첨 등으로 회사에 개인정보 제공 시 타인의 개인정보를 사용하거나 허위 사실을 기재하는 행위
                    다른 이용자의 이용자 계정을 도용 또는 부정하게 사용하거나 타인의 결제수단 내지 정보를 도용하여 유료콘텐츠를 구매하는 행위
                    유료콘텐츠 등 콘텐츠를 타인과 매매(증여 포함)하거나, 이를 취득하여 이용하는 행위
                    회사의 서비스 또는 애플리케이션을 이용하여 얻은 정보를 상업적/비상업적으로 이용하거나, 알려지지 않은 버그 등을 사용하여 서비스를 이용하는 행위
                    회사의 서비스 또는 애플리케이션을 이용하여 자기 또는 타인에게 재산상의 이익을 발생시키는 행위
                    타인의 명예를 훼손하거나 손해를 가하는 행위
                    회사 또는 제3자의 지적재산권, 초상권 등 기타 권리를 침해하는 행위
                    제3자를 기망하여 이익을 취하거나 또는 회사가 제공하는 서비스를 불건전하게 이용하거나 이용하여 제3자에게 피해를 주는 행위
                    음란, 저속한 정보를 교류, 게재 또는 음란 사이트를 연결(링크)하거나 승인되지 않은 광고 또는 홍보물을 게재하는 행위
                    재물을 걸고 도박하는 등 사행행위를 유도하거나 참여하는 행위
                    수치심, 혐오감 또는 공포심을 일으키는 문자, 기호, 음향, 영상 등을 다른 이용자에게 전송, 유포하는 행위
                    정보통신시스템, 데이터, 프로그램, 애플리케이션 등을 멸실, 훼손, 변조, 위조 등을 하거나 그 운용을 방해하는 행위
                    애플리케이션을 임의로 변경 또는 애플리케이션에 다른 프로그램을 추가∙삽입하거나 서버와 애플리케이션간 데이터 통신을 조작, 변경 등을 하는 행위
                    회사의 동의없이 영리, 영업, 광고, 정치활동, 불법 선거운동 등을 목적으로 서비스를 사용하는 행위
                    기타 공공질서 및 미풍양속을 위반하거나 불법적, 부당한 행위 및 관련법령에 위배되는 행위
                    ② 이용자는 회사의 서비스 공식 블로그 또는 애플리케이션내의 공지사항 및 약관 개정사항 등을 수시로 확인하고 준수할 의무가 있으며, 기타 회사의 업무에 방해되는 행위를 하여서는 안 됩니다.
                    ...
                    ⑤ 회사는 서비스 운영정책을 수시로 변경할 수 있으며, 서비스 운영정책을 변경하는 경우에는 제4조 제2항의 절차에 따릅니다.

                    제11조(서비스의 이용 및 중단 등)

                    ① 회사는 이용자에게 서비스 이용을 승낙한 때부터 서비스를 개시합니다. 다만, 일부 서비스의 경우 회사의 필요에 따라 지정된 일자부터 서비스를 제공합니다.
                    ② 이용자가 임시계정(Guest ID)를 사용하여 서비스를 이용하는 경우에는 단말기에서 애플리케이션 삭제하거나 단말기를 교체(변경)할 경우 유료콘텐츠 및 서비스 이용기록이 삭제될 수 있음으로 이용자 계정을 사용하여 서비스를 이용하는 것을 권장합니다. 회사는 이용자가 임시계정(Guest ID)으로 서비스를 이용하는 경우 최초 서비스 이용시점에 이러한 내용을 사전에 고지하며, 애플리케이션 삭제 혹은 단말기 교체로 인하여 발생하는 이용자의 손해에 대해 어떠한 책임도 부담하지 않습니다.
                    ...
                    ④ 회사는 업무상 또는 기술상 특별한 지장이 없는 한 연중무휴 1일 24시간 서비스를 제공합니다. 다만, 시스템 정기점검, 서버의 증설 및 교체, 각종 버그 패치, 서비스 변경 등 운영상 필요한 경우 일정기간 동안 서비스 이용을 일시 중단할 수 있습니다. 이러한 경우 회사는 그 내용 및 시간을 서비스 공식 블로그 또는 애플리케이션내의 공지사항 등을 통해 사전에 공지합니다. 다만, 회사가 사전에 공지할 수 없는 부득이한 사유가 있는 경우에는 사후에 공지할 수 있습니다.
                    ⑤ 회사는 영업양도, 분할∙합병 등에 따른 서비스의 폐지, 서비스 제공 계약 만료, 해당 서비스의 수익 악화 등 경영상의 중대한 사유로 인해 서비스를 지속하기 어려운 경우에는 서비스 전부를 중단할 수 있습니다. 이 경우 서비스 중단일 30일 이전에 중단사유 및 보상조건 등을 제4조 제2항에서 정한 방법으로 공지하며, 기간의 정함이 없는 유료콘텐츠의 이용기간은 서비스 중단 공지시 공지된 서비스 중단일까지로 합니다.

                    제12조(서비스 내용 및 변경)

                    ① 이용자는 이 약관 및 서비스 운영정책 또는 이용규칙에 따라 서비스를 이용하여야 합니다.
                    ② 회사는 서비스의 운영, 종료 등 서비스에 관한 포괄적인 권한을 가집니다.
                    ③ 회사는 다음 각호의 어느 하나에 해당되는 경우 서비스의 전부 또는 일부를 제한하거나 중지 또는 종료할 수 있습니다.
                    ...
                    ④ 회사는 단말기 알림(Push 알림)을 활용하여 이용자에게 광고를 발송할 수 있으며, 이용자는 언제든지 애플리케이션내의 수신거부 기능을 이용하여 수신을 거부할 수 있습니다.
                    ...
                    ④ 이용자는 유료콘텐츠를 이용자 계정에서만 이용할 수 있으며, 제3자에게 양도, 대여, 매매 또는 환전 등을 할 수 없습니다. 다만, 회사가 별도로 정하여 공지한 방법으로 이용인 경우에는 그러하지 않습니다.
                    ...
                    ① 이용자는 구매한 유료콘텐츠를 구매일 또는 유료콘텐츠 이용가능일로부터 7일 이내에, 유료 콘텐츠의 내용이 표시∙광고의 내용과 다르거나 구매 내용과 다르게 이행된 경우에는 유료콘텐츠의 이용 가능일부터 3개월 이내 또는 그 사실을 안 날이나 알 수 있었던 날부터 30일 이내에 별도의 수수료 없이 청약철회(구매 취소)를 할 수 있습니다. 다만, 청약철회 요청시 이미 사용하였거나 사용한 것으로 간주되는 유료콘텐츠 등 이에 준하는 특성을 가진 유료콘텐츠에 대하여는 청약철회(구매취소)가 제한될 수 있습니다.
                    ② 회사는 회사의 귀책사유로 인하여 이용자가 구매한 유료 콘텐츠를 서비스에서 이용하지 못하는 경우, 동일∙유사한 유료콘텐츠로 보상하거나 해당 구매 금액을 구매일에 관계없이 전액 환불합니다.
                    ③ 이용자가 구매한 유료콘텐츠에 대한 환불은 이용자가 이용한 앱스토어사업자의 환불 정책에 따라 진행되며, 자세한 환불 신청절차는 앱스토어사업자의 운영정책에 따릅니다. 또한 구매한 유료콘텐츠에 대한 환불이 완료된 경우에는 환불 금액만큼 유료콘텐츠가 차감됩니다. 또한, 유료콘텐츠가 다르게 지급된 경우에는 본조 제2항에서 정한 방법에 따릅니다. 다만, 이용자 다르게 지급된 유료콘텐츠 일부를 사용한 경우에는 유료콘텐츠로만 보상합니다.
                    ④ 유료콘텐츠를 콘텐츠로 전환한 경우, 전부 또는 일부 사용으로 인하여 서비스내에서 구매할 수 있는 기본 단위가 훼손된 경우, 메시지함 및/또는 선물함 등 유료콘텐츠의 송/수신과 관련된 화면에서 수락 등의 동의 과정을 거친 경우 등 이용자의 유료콘텐츠 이용으로 간주될 수는 사유가 있는 때에는 이용자가 사용의사를 밝힌 것으로 간주됩니다.
                    ...
                    개봉행위를 사용으로 볼 수 있거나 개봉 시 효용이 결정되는 캡슐형/확률형 유료콘텐츠를 개봉한 경우
                    유료콘텐츠의 일부를 사용하였거나 이미 시간이 지나 다시 판매하기 곤란한 경우
                    ...
                    ⑨ 선물하기 기능을 통하여 이루어진 In-App결제에 대해서는 구매한 유료콘텐츠에 하자가 있는 경우를 제외하고는 원칙적으로 결제 취소 또는 환불이 불가능하며, 유료콘텐츠의 하자로 인한 환불은 선물을 보낸 이용자에 한하여 가능합니다.

                    제17조(청약 철회 등의 효과)

                    ① 회사는 이용자가 제16조 제1항 본문에 따른 청약철회를 한 경우 지체없이 해당 유료콘텐츠를 회수 또는 삭제하고, 유료콘텐츠를 회수 또는 삭제한 날로부터 3영업일 이내에 지급받은 대금을 환불하거나 결제취소를 통해 환불 합니다.
                    ② 제1항의 경우 회사가 이용자에게 환불을 지연한 때에는 그 지연기간에 대하여 「전자상거래 등에서의 소비자보호에 관한 법률」 및 같은 법 시행령에서 정하는 이율을 곱하여 산정한 지연이자를 지급합니다.
                    ③ 회사는 환불을 함에 있어 이용자가 신용카드, 그 밖에 「전자상거래 등에서의 소비자보호에 관한 법률 시행령」에서 정한 결제수단으로 대금을 지급한 때에는 지체없이 당해 결제수단을 제공한 사업자로 하여금 대금의 청구를 정지 또는 취소하도록 요청합니다. 다만, 회사가 결제업자로부터 이미 대금을 지급받은 때에는 이를 결제업자에게 환불하고 이를 이용자에게 통지합니다.
                    ④ 이용자가 제16조 제1항 본문에 따른 청약철회를 한 경우 유료콘텐츠 등의 반환에 필요한 비용은 이용자가 부담(표시∙광고의 내용과 다르거나 구매 내용과 다르게 이행된 경우 제외)하고, 회사는 이용자에게 청약철회를 이유로 위약금 또는 손해배상을 청구하지 않습니다.

                    제18조(계약 해지 및 서비스 이용 중지 등)

                    ① 이용자는 언제든지 서비스의 이용을 원하지 않는 경우, 애플리케이션내의 탈퇴를 이용하여 이용계약을 해지할 수 있습니다.
                    ② 이용자가 서비스에서 탈퇴를 신청하는 경우, 이용자의 서비스 이용기록, 유∙무료콘텐츠 등 모든 정보가 삭제됨으로, 이용자는 서비스 탈퇴 전 유료콘텐츠의 환불을 요청하여야 합니다. 또한, 서비스 탈퇴를 신청한 경우에는 탈퇴 후 2주간(14일) 동안 서비스를 이용할 수 없습니다.
                    ...
                    ⑦ 회사는 이용자가 연속하여 1년 동안 서비스를 이용하지 않은 경우 이용자의 개인정보를 보호하기 위해 이용계약을 해지하고 이용자의 개인정보파기 또는 분리보관 등의 조치를 취할 수 있습니다. 이 경우 조치일 30일 전까지 조지 내용 등을 이용자에게 통지합니다.

                    제19조(잠정조치로서의 이용제한)

                    ① 회사는 다음 각호의 어느 하나에 해당하는 문제에 대한 조사가 완료될 때까지 이용자의 서비스 이용을 잠정적으로 중지할 수 있습니다.

                    이용자 계정이 해킹 또는 도용당하였다는 정당한 신고가 접수된 경우
                    서비스 운영정책에서 정하고 있는 제재대상 행위에 해당된다고 합리적으로 의심되는 경우
                    그 밖에 제1호 및 제2호에 준하는 행위에 해당된다고 판단되는 경우
                    ② 회사는 제1항 각호의 조사가 완료된 후 서비스 이용기간에 비례하여 유료콘텐츠의 이용기간을 연장합니다. 다만, 제1항에 의한 위법행위자로 확인된 경우에는 연장되지 않습니다.
            ...
            <div class="terms">
                ...
                <br/><br/>
                <p>
                    ('http://www.gamepicker.co.kr'이하 'GAMEPICKER')은(는) 개인정보보호법에 따라 이용자의 개인정보 보호 및 권익을 보호하고 개인정보와 관련한 이용자의 고충을 원활하게 처리할 수 있도록 다음과 같은 처리방침을 두고 있습니다.

                    ('GAMEPICKER') 은(는) 회사는 개인정보처리방침을 개정하는 경우 웹사이트 공지사항(또는 개별공지)을 통하여 공지할 것입니다.

                    ○ 본 방침은부터 *2018*년 12월 *20*일부터 시행됩니다.

                    **1. 개인정보의 처리 목적 ('http://GAMEPICKER'이하 'GAMEPICKER')은(는) 개인정보를 다음의 목적을 위해 처리합니다. 처리한 개인정보는 다음의 목적이외의 용도로는 사용되지 않으며 이용 목적이 변경될 시에는 사전동의를 구할 예정입니다.**

                    가. 홈페이지 회원가입 및 관리

                    회원 가입의사 확인, 회원제 서비스 제공에 따른 본인 식별·인증, 회원자격 유지·관리, 제한적 본인확인제 시행에 따른 본인확인, 서비스 부정이용 방지, 분쟁 조정을 위한 기록 보존 등을 목적으로 개인정보를 처리합니다.
                    ...
                    서비스 제공, 청구서 발송, 콘텐츠 제공, 맞춤 서비스 제공, 본인인증, 연령인증 등을 목적으로 개인정보를 처리합니다.
                    ...
                    **2. 개인정보 파일 현황**
                    ...
                    1. 개인정보 파일명 : 내콘텐츠 개인정보처리방침- 개인정보 항목 : 이메일, 비밀번호, 로그인ID, 성별, 서비스 이용 기록, 접속 로그, 쿠키, 접속 IP 정보, 결제기록, 개인 영상물- 수집방법 : 홈페이지, 서면양식, 생성정보 수집 툴을 통한 수집, 앱을 통해 수집- 보유근거 : 정보주체의 동의- 보유기간 : 3년- 관련법령 : 신용정보의 수집/처리 및 이용 등에 관한 기록 : 3년, 소비자의 불만 또는 분쟁처리에 관한 기록 : 3년

                    **3. 개인정보의 처리 및 보유 기간**① *('*GAMEPICKER*')*은(는) 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터 개인정보를 수집시에 동의 받은 개인정보 보유,이용기간 내에서 개인정보를 처리,보유합니다.② 각각의 개인정보 처리 및 보유 기간은 다음과 같습니다.

                    1.<홈페이지 회원가입 및 관리><홈페이지 회원가입 및 관리>와 관련한 개인정보는 수집.이용에 관한 동의일로부터<3년>까지 위 이용목적을 위하여 보유.이용됩니다.-보유근거 : 정보주체의 동의-관련법령 : 1)신용정보의 수집/처리 및 이용 등에 관한 기록 : 3년2) 소비자의 불만 또는 분쟁처리에 관한 기록 : 3년-예외사유 :

                    **4. 개인정보의 제3자 제공에 관한 사항**① *('http://www.gamepicker.co.kr'이하 'GAMEPICKER')*은(는) 정보주체의 동의, 법률의 특별한 규정 등 개인정보 보호법 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.

                    *('http://gamepicker.co.kr')*

                    은(는) 다음과 같이 개인정보를 제3자에게 제공하고 있습니다.

                    1. - 개인정보를 제공받는 자 : GAMEPICKER- 제공받는 자의 개인정보 이용목적 : 이메일, 휴대전화번호, 비밀번호, 로그인ID, 성별, 서비스 이용 기록, 접속 로그, 쿠키, 접속 IP 정보, 결제기록, 개인 영상물- 제공받는 자의 보유.이용기간: 3년

                    **5. 개인정보처리 위탁**

                    ① *('GAMEPICKER')*은(는) 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.

                    1. <>- 위탁받는 자 (수탁자) : - 위탁하는 업무의 내용 : - 위탁기간 :

                    ②*('http://gamepicker.co.kr'이하 'GAMEPICKER')*
                    ...
                    **6. 정보주체와 법정대리인의 권리·의무 및 그 행사방법 이용자는 개인정보주체로써 다음과 같은 권리를 행사할 수 있습니다.**
                    ...
                    ① 정보주체는 GAMEPICKER에 대해 언제든지 개인정보 열람,정정,삭제,처리정지 요구 등의 권리를 행사할 수 있습니다.② 제1항에 따른 권리 행사는 GAMEPICKER에 대해 개인정보 보호법 시행령 제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며 GAMEPICKER은(는) 이에 대해 지체 없이 조치하겠습니다.③ 제1항에 따른 권리 행사는 정보주체의 법정대리인이나 위임을 받은 자 등 대리인을 통하여 하실 수 있습니다. 이 경우 개인정보 보호법 시행규칙 별지 제11호 서식에 따른 위임장을 제출하셔야 합니다.④ 개인정보 열람 및 처리정지 요구는 개인정보보호법 제35조 제5항, 제37조 제2항에 의하여 정보주체의 권리가 제한 될 수 있습니다.⑤ 개인정보의 정정 및 삭제 요구는 다른 법령에서 그 개인정보가 수집 대상으로 명시되어 있는 경우에는 그 삭제를 요구할 수 없습니다.⑥ GAMEPICKER은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한 대리인인지를 확인합니다.

                    **7. 처리하는 개인정보의 항목 작성** ① *('http://gamepicker.co.kr'이하 'GAMEPICKER')*은(는) 다음의 개인정보 항목을 처리하고 있습니다.

                    1<홈페이지 회원가입 및 관리>- 필수항목 : 이메일, 휴대전화번호, 비밀번호, 로그인ID, 성별, 서비스 이용 기록, 접속 로그, 쿠키, 접속 IP 정보, 결제기록, 개인 영상물- 선택항목 :

                    **8. 개인정보의 파기*('GAMEPICKER')*은(는) 원칙적으로 개인정보 처리목적이 달성된 경우에는 지체없이 해당 개인정보를 파기합니다. 파기의 절차, 기한 및 방법은 다음과 같습니다.**
                    ...
                    -파기방법전자적 파일 형태의 정보는 기록을 재생할 수 없는 기술적 방법을 사용합니다.종이에 출력된 개인정보는 분쇄기로 분쇄하거나 소각을 통하여 파기합니다.DB 및 서버 파기

                    **9. 개인정보 자동 수집 장치의 설치•운영 및 거부에 관한 사항**

                    ① GAMEPICKER은 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고 수시로 불러오는 ‘쿠기(cookie)’를 사용합니다. ② 쿠키는 웹사이트를 운영하는데 이용되는 서버(http)가 이용자의 컴퓨터 브라우저에게 보내는 소량의 정보이며 이용자들의 PC 컴퓨터내의 하드디스크에 저장되기도 합니다. 가. 쿠키의 사용 목적 : 이용자가 방문한 각 서비스와 웹 사이트들에 대한 방문 및 이용형태, 인기 검색어, 보안접속 여부, 등을 파악하여 이용자에게 최적화된 정보 제공을 위해 사용됩니다. 나. 쿠키의 설치•운영 및 거부 : 웹브라우저 상단의 도구>인터넷 옵션>개인정보 메뉴의 옵션 설정을 통해 쿠키 저장을 거부 할 수 있습니다. 다. 쿠키 저장을 거부할 경우 맞춤형 서비스 이용에 어려움이 발생할 수 있습니다.

                    **10. 개인정보 보호책임자 작성**

                    ① GAMEPICKER(‘http://*gamepicker*.co.kr’이하 ‘GAMEPICKER') 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.

                    ▶ 개인정보 보호책임자 성명 : 신문기 직책 :개발자직급 :공동대표연락처 : gamepicker.inc@gmail.com, ※ 개인정보 보호 담당부서로 연결됩니다.▶ 개인정보 보호 담당부서부서명 :담당자 :연락처 : , ② 정보주체께서는 GAMEPICKER(‘http://*gamepicker*.co.kr’이하 ‘GAMEPICKER) 의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. GAMEPICKER(‘http://*gamepicker*.co.kr’이하 ‘GAMEPICKER) 은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.

                    **11. 개인정보 처리방침 변경**

                    ①이 개인정보처리방침은 시행일로부터 적용되며, 법령 및 방침에 따른 변경내용의 추가, 삭제 및 정정이 있는 경우에는 변경사항의 시행 7일 전부터 공지사항을 통하여 고지할 것입니다.

                    **12. 개인정보의 안전성 확보 조치 *('GAMEPICKER')*은(는) 개인정보보호법 제29조에 따라 다음과 같이 안전성 확보에 필요한 기술적/관리적 및 물리적 조치를 하고 있습니다.**
                    ...
                    **13. 개인정보 열람청구① 정보주체는 개인정보 보호법 제35조에 따른 개인정보의 열람 청구를 아래의 부서에 할 수 있습니다. *(‘http://GAMEPICKER.co.kr'이하 'GAMEPICKER')*은(는) 정보주체의 개인정보 열람청구가 신속하게 처리되도록 노력하겠습니다.**

                    ▶ 개인정보 열람청구 접수·처리 부서 부서명 : GAMEPICKER 담당자 : 최성묵연락처 : gamepicker.inc@gmail.com
                    ...
                    **14. 정보주체의 권익침해에 대한 구제방법**
                    ...
                    아래의 기관은 GAMEPICKER과는 별개의 기관으로서,

                    *(‘http://GAMEPICKER.co.kr'이하 '*GAMEPICKER*')*

                    의 자체적인 개인정보 불만처리, 피해구제 결과에 만족하지 못하시거나 보다 자세한 도움이 필요하시면 문의하여 주시기 바랍니다.

                    ▶ 개인정보 침해신고센터 (한국인터넷진흥원 운영) - 소관업무 : 개인정보 침해사실 신고, 상담 신청 - 홈페이지 : privacy.kisa.or.kr - 전화 : (국번없이) 118 - 주소 : (58324) 전남 나주시 진흥길 9(빛가람동 301-2) 3층 개인정보침해신고센터 ▶ 개인정보 분쟁조정위원회 - 소관업무 : 개인정보 분쟁조정신청, 집단분쟁조정 (민사적 해결) - 홈페이지 : www.kopico.go.kr - 전화 : (국번없이) 1833-6972 - 주소 : (03171)서울특별시 종로구 세종대로 209 정부서울청사 4층 ▶ 대검찰청 사이버범죄수사단 : 02-3480-3573 (www.spo.go.kr)▶ 경찰청 사이버안전국 : 182 (http://cyberbureau.police.go.kr)
                </p>
                <br/>
                <div class="isAgrees">
                    약관에 동의 하십니까?&nbsp;&nbsp;&nbsp;동의
